# Adopted from https://github.com/haotian-liu/LLaVA/blob/31cceb8/llava/train/train.py. Below is the original copyright:
...
def create_llava_model(config_file):
    ...
    return model, tokenizer, data_args, training_args